...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-swp-ski.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-swp-ski.containers.anotherwebservice.com/
...
```
git clone git@github.com:inforcelaw/container-swp-ski.git
cd container-swp-ski
```
...
```
docker attach container-swp-ski
```
